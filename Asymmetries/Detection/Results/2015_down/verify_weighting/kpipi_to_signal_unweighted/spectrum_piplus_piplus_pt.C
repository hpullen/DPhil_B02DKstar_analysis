...
//=========  (Tue Nov 13 22:09:56 2018) by ROOT version6.08/06
   ...
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(1,0.0245869);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(2,0.09944095);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(3,0.2663567);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(4,0.1603762);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(5,0.1590099);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(6,0.1257908);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(7,0.08169612);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(8,0.05422004);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(9,0.02288878);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(10,0.003675191);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinContent(11,0.001958346);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(1,0.01843794);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(2,0.03892658);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(3,0.05792249);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(4,0.04483393);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(5,0.04609246);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(6,0.04014026);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(7,0.02314555);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(8,0.02056063);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(9,0.008020474);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(10,0.002794917);
   kpipi_to_signal_pi_spectra_to_pt__22->SetBinError(11,0.002138838);
   kpipi_to_signal_pi_spectra_to_pt__22->SetEntries(335);
