...
int main(int argc, char * argv[]) {
    ...
    params << "sigma_1a " << ratio_1a.getVal() << " " << sigma_1a.getError() << std::endl;
    ...
    params << "sigma_2 " << ratio_2.getVal() << " " << sigma_2.getError() << std::endl;
    ...
    params << "sigma_3 " << ratio_3.getVal() << " " << sigma_3.getError() << std::endl;
    ...
    params << "sigma_5a " << ratio_5a.getVal() << " " << sigma_5a.getError() << std::endl;
