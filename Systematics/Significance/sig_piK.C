...
{  
  ...
  x[n] = 0.02; y[n] = 42485.9; z[n]=y[n]-miny; s[n]=sqrt(2*z[n]); n++;
  x[n] = 0.04; y[n] = 42480.6; z[n]=y[n]-miny; s[n]=sqrt(2*z[n]); n++;
  x[n] = 0.06; y[n] = 42477.6; z[n]=y[n]-miny; s[n]=sqrt(2*z[n]); n++;
