...
{  
  ...
  x[n] = 0.02; y[n] = 42481.4; z[n]=y[n]-miny; s[n]=sqrt(2*z[n]); n++;
  x[n] = 0.04; y[n] = 42478.4; z[n]=y[n]-miny; s[n]=sqrt(2*z[n]); n++;
  x[n] = 0.06; y[n] = 42476.9; z[n]=y[n]-miny; s[n]=sqrt(2*z[n]); n++;
  ...
  gr->GetXaxis()->SetTitle("R_{ADS}(DK^{*0}) ");
  ...
  gs->SetTitle("");
  gs->GetXaxis()->SetTitle("R_{ADS}(DK^{*0}) ");
  ...
  gL->GetXaxis()->SetTitle("R_{ADS}(DK^{*0}) ");
