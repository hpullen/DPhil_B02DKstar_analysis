...
# =============================================================
dtt = DecayTreeTuple('Tuple_4pi')
dtt.Inputs = ['/Phys/{0}/Particles'.format(line)]
dtt.Decay = ('[[B0 -> ^(D0 -> ^pi+ ^pi- ^pi+ ^pi-) ^(K*(892)0 -> ^K+ ^pi-)]CC,'
...
# ===============================
Kpi_h = [dtt.D0PiPlus1, dtt.D0PiMinus1, dtt.D0PiPlus2, dtt.D0PiMinus2, dtt.KstarK, 
         dtt.KstarPi]
...
DaVinci().TupleFile = 'Tuple_K3pi.root'
