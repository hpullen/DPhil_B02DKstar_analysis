...
print_table() {
    ...
    DESC=$1
    shift
    OUTFILE="../../../ANA_resources/Tables/Systematics/${NAME}_final_values_splitObs.tex"
    ...
    echo "\\caption{Final result for ${DESC} physics observables split between Run 1 and Run 2.}" >> $OUTFILE
    echo "\\label{tab:results_splitObs_${NAME}}" >> $OUTFILE
...
print_table twoBody 'two-body' A_signal_Kpi A_Bs_piK R_signal_piK_plus R_signal_piK_minus A_signal_KK R_signal_KK A_Bs_KK R_Bs_KK A_signal_pipi R_signal_pipi A_Bs_pipi R_Bs_pipi
print_table fourBody 'four-body' A_signal_Kpipipi A_Bs_piKpipi R_signal_piKpipi_plus R_signal_piKpipi_minus A_signal_pipipipi R_signal_pipipipi A_Bs_pipipipi R_Bs_pipipipi
