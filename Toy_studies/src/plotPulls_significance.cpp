...
int main (int argc, char * argv[]) {
    ...
    // Make histograms
    TH1F * sig_hist = new TH1F("hist_significance", "", 20, 0, 10);
    ...
    double max_like = min_max_likelihood.second +
        (min_max_likelihood.second - min_max_likelihood.first)/8;
    TH1F * signal_likelihood_hist = new TH1F("hist_signal_likelihood", "", 50, 
            min_like, max_like);
    TH1F * nosignal_likelihood_hist = new TH1F("hist_nosignal_likelihood", "", 50, 
            min_like, max_like);
    ...
    toy_tree->Draw("signal_likelihood >> hist_signal_likelihood", "status == 0");
    ...
    signal_chi2_hist->GetXaxis()->SetTitle("#chi^{2}");
