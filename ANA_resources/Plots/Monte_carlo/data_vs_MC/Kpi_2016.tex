...
\end{tabular}
\caption{Comparison of 2016 data (red points) and Monte Carlo (black histogram) in the $K\pi$ mode for the variables used to train the $K\pi$ BDT. The result of the Kolmogorov Smirnov test on the two histograms is shown in the top-right corner of each plot}
