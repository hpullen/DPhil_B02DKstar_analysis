...
int main(int argc, char * argv[]) {
    ...
    // Make the fitter
    TwoAndFourBodyFitter * fitter = new TwoAndFourBodyFitter();
    ...
    // Fit
    fitter->PerformFit("Results/twoAndFourBody_data.root", 
        "Histograms/twoAndFourBody_data.root");

    // Plot
    Plotter * plotter = new Plotter("Histograms/twoAndFourBody_data.root",
            "Plots/twoAndFourBody_data", {"Kpi", "piK", "KK", "pipi", "Kpipipi",
            "piKpipi", "pipipipi"});
