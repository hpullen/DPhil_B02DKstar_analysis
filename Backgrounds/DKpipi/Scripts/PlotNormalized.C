...
void PlotNormalized() {
    ...
    hist_1a->Scale(1/hist_1a->Integral());
    hist_1b->Scale(1/hist_1b->Integral());
    hist_2->Scale(1/hist_2->Integral());
    hist_3->Scale(1/hist_3->Integral());
    hist_4->Scale(1/hist_4->Integral());
    hist_5a->Scale(1/hist_5a->Integral());
    hist_5b->Scale(1/hist_5b->Integral());
    hist_6->Scale(1/hist_6->Integral());
    hist_7a->Scale(1/hist_7a->Integral());
    hist_7b->Scale(1/hist_7b->Integral());
    hist_10->Scale(1/hist_10->Integral());

    // Set labels
    hist_1a->GetXaxis()->SetTitle("Reconstructed B^{0} mass / GeV");
    hist_1a->GetYaxis()->SetTitle("Normalized entries");
